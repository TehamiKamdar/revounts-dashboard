...
class UpdateAdvertiserStatusOnFetchTimeJobByID implements ShouldQueue
{
    ...
    {
        $data = $this->data;
        $advertiserIdz = $data['ids'];

        AdvertiserApply::whereIn("internal_advertiser_id", $advertiserIdz)->orderBy('created_at')->chunk(5, function ($advertisers) use ($data) {
