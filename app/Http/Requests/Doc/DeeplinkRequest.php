...
class DeeplinkRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'landing_url' => 'required|string|url|max:1000',
        ];
    }
    ...
    public function bodyParameters()
    {
        return [
            ...
            'landing_url' => [
                'description' => 'It must be a valid URL and should not exceed 191 characters in length.',
                'example' => 'https://www.esm-computer.de/',
            ]
        ];
    }
}
