    ...
    return [
        ...
        'routes' => [
            [
                 ...
                 */
                'exclude' => [
                    'api/documentation', 'api/documentation-2', 'api/oauth2-callback', 'api/user'
                ],
        ...
        'try_it_out' => [
             ...
             */
            'base_url' => env('DOC_APP_URL', 'http://api.test.local'),
         ...
         */
        'intro_text' => <<<INTRO
    This documentation is intended to offer all the information necessary for you to effectively utilize our API.
    ...
    INTRO
         ...
         * - 'logo' => 'img/logo-white.png' // for `laravel` type
         *
         */
        'logo' => env('APP_URL', 'http://localhost') . 'img/logo-white.png',
