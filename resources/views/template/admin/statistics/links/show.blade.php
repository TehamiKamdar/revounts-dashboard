...
@section("content")
    ...
    <div class="container-fluid">
        <h1 class="title">{{ trans('global.show') }} {{ trans('link.statistics.links.title_singular') }}</h1>
        <a href="{{ route("admin.statistics.links.index") }}"
        ...
        <div class="content-card">
            ...
            <div class="card-header-modern">
                <h2 class="card-title-modern">
                    <i
                        class="ri-user-3-line"></i>{{ isset($link->publisher->first_name) && isset($link->publisher->last_name) ? $link->publisher->first_name . " " . $link->publisher->last_name : "-" }}
                </h2>
