                        ...
                        <div class="breadcrumb-main">
                            ...
                            <div class="breadcrumb-action justify-content-center flex-wrap">
                                <div class="action-btn">
                                    <a href="{{ route("admin.statistics.links.index") }}" class="breadcrumb-remove border-0 color-danger content-center bg-white fs-12 fw-500 ml-10 radius-md">
                                            ...
                                            <table class="table table-bordered table-social">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ isset($link->publisher->first_name) && isset($link->publisher->last_name) ? $link->publisher->first_name . " " . $link->publisher->last_name : "-" }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                                ...
                                                                {
                                                            ?>
                                                                    <a href="{{ $link->click_through_url }}" target="_blank">{{ $link->click_through_url }}</a>
                                                            <?php
                                                                } else
                                                                {
                                                                    echo "-";
                                                    ...
                                                    <tr>
                                                        <th>
                                                            {{ trans('link.statistics.links.fields.tracking_url_short') }}
                                                        </th>
                                                        <td>
                                                            <?php
                                                                ...
                                                                {
                                                            ?>
                                                                    <a href="{{ $link->tracking_url_short }}" target="_blank">{{ $link->tracking_url_short }}</a>
                                                            <?php
                                                                } else
                                                                {
                                                                    echo "-";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ \Carbon\Carbon::parse($link->created_at)->format("Y-m-d h:i:s a") }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>
                                                        ...
                                                        <td>
                                                            {{ \Carbon\Carbon::parse($link->updated_at)->format("Y-m-d h:i:s a") }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
