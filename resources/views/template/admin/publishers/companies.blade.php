    ...
    <div class="changelog__accordingWrapper">
        <div id="accordionCompanies">
            @foreach($publisher->companies as $key => $company)
                <div class="card">
                    <div class="card-header bg-primary-dark w-100" id="companyContent{{ $company->id }}">
                        <div role="button" class="w-100 changelog__accordingCollapsed {{ $key > 0 ? "collapsed" : null }}"
                            data-bs-toggle="collapse" data-bs-target="#collapse{{ $company->id }}"
                            aria-expanded="{{ $key == 0 }}" aria-controls="collapse{{ $company->id }}">
                    ...
                    <div id="collapse{{ $company->id }}" class="collapse {{ $key == 0 ? "show" : null }}"
                        aria-labelledby="companyContent{{ $company->id }}" data-parent="#accordionCompanies">
                        <div class="card-body">
