...
@pushonce('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const announcementText = "Thank You for pre-registering with LinksCircle. We will start affiliation approvals in {{ now()->format('F Y') }}. Our team will contact you after the launch.";
                    ...
                    <div class="announcement-footer">
                        <div class="countdown-card">
                            ...
                            <div class="countdown-content">
                                ...
                                <div class="countdown-value">{{ now()->format('F Y') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
