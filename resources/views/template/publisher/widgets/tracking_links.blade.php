...
<div class="revenue-device-chart">
    ...
    <div class="card broder-0">
        <div class="card-header">
            <h6>Tracking Link Current Month Report</h6>
        </div>
        <!-- ends: .card-header -->
        <div class="card-body">
                ...
                <div class="tab-pane fade active show" id="rb_device-today" role="tabpanel" aria-labelledby="rb_device-today-tab">
                    <div class="revenue-pieChart-wrap">
                        <div>
                            ...
                            <canvas id="chartDoughnut3Extra" height="173" style="display: block; width: 426px; height: 173px;" width="426" class="chartjs-render-monitor"></canvas>
                        </div>
                    </div>
...
@push("extended_scripts")
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            chartjsDoughnutExtra("chartDoughnut3Extra", "122", (data = [{{ $trackingLinkComplete }}, {{ $trackingLinkPending }}, {{ $trackingLinkRetry }}]), ["Complete", "Pending", "Failed"]);
        });
    </script>
@endpush
