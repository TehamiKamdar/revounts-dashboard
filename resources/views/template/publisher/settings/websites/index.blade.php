            ...
            <tbody id="websiteContent">
                @foreach($websites as $website)
                                <tr id="website-row-{{ $website->id }}">
                                    <td>
                                        <a class="nav-link" href="{{ url($website->url) }}" target="_blank">{{ $website->name }}</a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        @if($website->status == \App\Models\Website::PENDING)
                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#verify-modal"
                                                onclick="openVerifyModal('{{ $website->id }}', '{{ $website->url }}')">Verify</a> |
                                        @endif
                                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#website-modal"
                                            onclick="openWebsiteModal(1, '{{ $website->id }}')">Edit</a>
                                    </td>
                                </tr>
                @endforeach
            </tbody>
