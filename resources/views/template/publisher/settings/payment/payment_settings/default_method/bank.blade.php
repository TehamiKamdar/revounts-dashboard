<div class="card-body mt-30 bg-normal bg-shadow radius-xl px-sm-20 px-10 pt-15  mb-20">
    ...
    <div class="d-flex mb-20 align-items-center">
        ...
        <span class="crc__method"><img class="h-auto"
                                       src="{{ \App\Helper\Static\Methods::staticAsset("img/bank.png") }}" alt="img"> @if($payment->account_holder_name){{ str_repeat('•', strlen($payment->account_holder_name) - 6) . substr($payment->account_holder_name, -6) }}@endif</span>
    </div>
    <button type="button"
