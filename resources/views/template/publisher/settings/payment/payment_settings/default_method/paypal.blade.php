<div class="card-body mt-30 bg-normal bg-shadow radius-xl px-sm-20 px-10 pt-15  mb-20">
    <div class="crc__title mb-25">
        <h6 class="color-gray">Default Payment Method</h6> <span
            class="badge badge-round badge-success badge-lg">Active</span>
    </div>
    <div class="d-flex mb-20 align-items-center">
        ...
        <span class="crc__method"><img class="h-auto" src="{{ \App\Helper\Static\Methods::staticAsset("img/paypal.png") }}"
                                       alt="img"> @if(isset($payment->paypal_holder_name)){{ str_repeat('•', strlen($payment->paypal_holder_name) - 6) . substr($payment->paypal_holder_name, -6) }}@endif</span>
    </div>
    <button type="button"
