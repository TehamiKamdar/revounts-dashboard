                ...
                <div class="edit-profile__body">
                    <form id="stepTwo" action="javascript:void(0)">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="website_url" name="website_url" placeholder="https://example.com" value="{{ $stepOne['website_url'] ?? null }}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="address" name="address" placeholder="Enter Complete Address" value="{{ $stepOne['address'] ?? null }}" />
                            </div>
                        </div>
