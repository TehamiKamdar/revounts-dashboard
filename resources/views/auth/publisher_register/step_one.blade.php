                ...
                <form id="stepOne" class="stepOne" action="javascript:void(0)">
                    ...
                    <div class="form-group create-passord">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="ri-eye-close-line text-light fs-16 field-icon" id="password-icon" onclick="showPassword('password')"></div>
                        </div>
                    </div>
                    <div class="form-group create-passord">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="ri-eye-close-line text-light fs-16 field-icon" id="password_confirmation-icon" onclick="showPassword('password_confirmation')"></div>
                        </div>
                    </div>
                    ...
                    <div class="button-group d-flex pt-20 mb-20 justify-content-md-end justify-content-center">
                        <button type="submit" class="btn text-white btn-primary btn-default btn-squared text-capitalize m-1">Save &amp; Next<i class="ml-10 mr-0 ri-arrow-right-line"></i></button>
                    </div>
                </form>
            </div>
        </div>
