                ...
                <div class="col-xl-6">
                    ...
                    <div class="signUp-topbar">
                        <form method="POST" action="<?php echo e(route('logout')); ?>">
                            ...
                            <button type="submit" class="btn btn-danger">
                                <i class="ri-logout-box-r-line mr-10"></i><?php echo e(__('Log Out')); ?>
                    ...
                    <div class="verification-card">
                        ...
                        <div class="verification-body">
                            ...
                            <form class="verification-form" method="POST" action="<?php echo e(route('verification.send')); ?>">
                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\lenovo\Downloads\revdb\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>