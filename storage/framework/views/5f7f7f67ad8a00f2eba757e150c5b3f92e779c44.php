<?php if (! $__env->hasRenderedOnce('cdb169d2-e1fa-4371-9e80-cabe7e5bb072')): $__env->markAsRenderedOnce('cdb169d2-e1fa-4371-9e80-cabe7e5bb072');
...
<?php if (! $__env->hasRenderedOnce('6305c3d0-00f1-47a7-94f6-e27eb3a1f327')): $__env->markAsRenderedOnce('6305c3d0-00f1-47a7-94f6-e27eb3a1f327');
$__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            $("#allBrands, #notJoinedBrands, #joinedBrands, #newBrands, #pendingBrands, #rejectedBrands, #holdBrands")
                .click(function(e) {
                    $("#ap-tabContent").addClass("spin-active");
                    $("#gridLoader3").removeClass("display-hidden");
                    let data = $(e.target);
                    let section = data.attr('data-section');
                    $("#allBrands, #newBrands, #notJoinedBrands, #joinedBrands, #newBrands, #pendingBrands, #holdBrands, #rejectedBrands")
                        .removeClass("active");
                    if (section === "all") {
                    ...
                    <div class="filter-grid">
                        ...
                        <div class="filter-card">
                            ...
                            <select id="SearchByCountry" class="form-control form-control-sm" multiple>
                                ...
                                } elseif (request()->search_by_country) {
                        ...
                        <div class="filter-card">
                            ...
                            <select id="SearchByCategory" class="form-control" multiple>
                                ...
                                } elseif (request()->search_by_category) {
                        ...
                        <div class="filter-card">
                            ...
                            <select id="SearchByPromotionalMethod" class="form-select form-select-sm" multiple>
                                ...
                                } elseif (request()->search_by_promotional_method) {
                        ...
                        <form action="<?php echo e(route('publisher.send-msg-to-advertiser')); ?>" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="question_or_comment" id="question_or_comment" class="form-control form-control-sm"
...
<?php echo $__env->make('layouts.publisher.panel_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\revdb\resources\views/template/publisher/advertisers/find.blade.php ENDPATH**/ ?>