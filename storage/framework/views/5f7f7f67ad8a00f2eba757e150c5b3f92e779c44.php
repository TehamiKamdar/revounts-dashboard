        ...
        $countriesArr = [request()->search_by_country];
                            ...
                            <div class="filter-card">
                                ...
                                <select class="form-select" id="advertiserType">
                                    ...
                                    <option value="third_party_advertiser" <?php echo e(request()->type == "third_party_advertiser" ? "selected" : ""); ?>>Third-Party
                                        Advertisers</option>
                                    <option value="managed_by_linksCircle" <?php echo e(request()->type == "managed_by_linksCircle" ? "selected" : ""); ?>>Managed by
                                        LinksCircle</option>
                                </select>
                            </div>
