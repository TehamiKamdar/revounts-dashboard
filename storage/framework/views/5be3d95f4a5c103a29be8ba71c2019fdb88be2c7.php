<script>
    function openVerifyModal(id, url)
    {
        ...
        $("#websiteVerify").click(function () {
            ...
            $("#showLoader").show();
            $.ajax({
                url: '<?php echo e(route("publisher.profile.websites.verification")); ?>',
                type: 'POST',
    ...
    function websiteForm()
    {
        ...
        $("#websiteForm").validate({
            ...
            submitHandler: () => {
                ...
                if($("#website_id").val()) {
                    url = '<?php echo e(route("publisher.profile.websites.update")); ?>';
                    method = 'PATCH';
                } else {
                    url = '<?php echo e(route("publisher.profile.websites.store")); ?>';
                    method = 'POST';
                }
...
<?php /**PATH C:\Users\lenovo\Downloads\revdb\resources\views/template/publisher/settings/websites/js.blade.php ENDPATH**/ ?>