    ...
    <div class="container">
        <div class="logo animate-in">
            <a href="https://www.linkscircle.com/">
                <img src="<?php echo e(\App\Helper\Static\Methods::staticAsset('img/logo.png')); ?>" alt="LinksCircle Affiliate Network" class="img-fluid">
            </a>
        </div>
        ...
        <div class="main-content">
            ...
            <div class="account-cards">
                <a class="account-card animate-in delay-2" href="<?php echo e(route('register', ['type' => 'publisher'])); ?>">
                    <div class="card-icon">
            ...
            <div class="login-section animate-in">
                ...
                <a href="<?php echo e(route('login', ['type' => 'advertiser'])); ?>" class="login-button">Log In</a>
            </div>
        </div>
    </div>
