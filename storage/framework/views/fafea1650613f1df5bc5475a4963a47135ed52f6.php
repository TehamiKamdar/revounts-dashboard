<?php if (! $__env->hasRenderedOnce('98fed6a9-046d-4d18-b979-a42c626b5e37')): $__env->markAsRenderedOnce('98fed6a9-046d-4d18-b979-a42c626b5e37');
...
<?php if (! $__env->hasRenderedOnce('36b7ced7-9f0f-42dc-98ff-d113a173ae27')): $__env->markAsRenderedOnce('36b7ced7-9f0f-42dc-98ff-d113a173ae27');
                                        ...
                                        <div class="project-category__select global-shadow ">
                                            <select class="js-example-basic-single js-states form-control" id="sortBy">
                                                <option <?php echo e(request()->earning_sort == "advertiser" || empty(request()->earning_sort) ? "selected" : ""); ?> value="advertiser">
                                                    Advertiser</option>
                                                <option <?php echo e(request()->earning_sort == "sale" ? "selected" : ""); ?>
                                            ...
                                            <select class="js-example-basic-single js-states form-control" id="region">
                                                ...
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($country->advertiser_country): ?>
                                                        <option <?php echo e(request()->region == $country->advertiser_country ? "selected" : ""); ?> value="<?php echo e($country->advertiser_country); ?>">
                                                            <?php echo e($country->advertiser_country); ?></option>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e(request()->region == "unknown" ? "selected" : ""); ?>
...
<?php echo $__env->make("layouts.publisher.panel_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Tehami\Desktop\revounts-dashboard\resources\views/template/publisher/reports/performance/transaction/list.blade.php ENDPATH**/ ?>