<?php if (! $__env->hasRenderedOnce('19aee48f-3585-43ea-a8f9-27d438c3625c')): $__env->markAsRenderedOnce('19aee48f-3585-43ea-a8f9-27d438c3625c');
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="breadcrumb-main">
                            <h4 class="text-capitalize breadcrumb-title"><?php echo e(trans('global.show')); ?> <?php echo e(trans('cruds.publisher.title_singular')); ?></h4>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-overview border-0">
                            <div class="card-header">
                                <h6><?php echo e($publisher->first_name); ?> <?php echo e($publisher->last_name); ?></h6>
