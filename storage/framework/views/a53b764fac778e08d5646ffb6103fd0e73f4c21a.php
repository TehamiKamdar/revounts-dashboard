    ...
    <div class="changelog__accordingWrapper">
        <div id="accordionWebsites">
            <?php $__currentLoopData = $publisher->websites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $website): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                <div class="card">
                    <div class="card-header w-100" id="websiteContent<?php echo e($website->id); ?>">
                        <div role="button" class="w-100 changelog__accordingCollapsed <?php echo e($key > 0 ? "collapsed" : null); ?>" data-toggle="collapse" data-target="#collapse<?php echo e($website->id); ?>" aria-expanded="<?php echo e($key == 0); ?>" aria-controls="collapse<?php echo e($website->id); ?>">
                            <div class="changelog__accordingTitle d-flex justify-content-between w-100">
                                <div class="v-num">Website Information (<?php echo strtolower($url); ?>)</div>
