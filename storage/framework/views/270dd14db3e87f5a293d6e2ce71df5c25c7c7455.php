<?php if (! $__env->hasRenderedOnce('3e0a5f08-8da6-4cc9-b180-a4e88a41cc70')): $__env->markAsRenderedOnce('3e0a5f08-8da6-4cc9-b180-a4e88a41cc70');
...
<?php if (! $__env->hasRenderedOnce('80b3eb4e-1511-48b6-8509-ca408c0e552c')): $__env->markAsRenderedOnce('80b3eb4e-1511-48b6-8509-ca408c0e552c');
                    ...
                    <div class="content-modern">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <?php if(request()->is('publisher/profile/basic-information')): ?>
                                <div class="tab-pane-modern fade <?php if(request()->is('publisher/profile/basic-information')): ?> active show <?php endif; ?>"
                            ...
                            <?php elseif(request()->is('publisher/profile/company')): ?>
                                <div class="tab-pane-modern fade <?php if(request()->is('publisher/profile/company')): ?> active show <?php endif; ?>"
                            ...
                            <?php elseif(request()->is('publisher/profile/websites')): ?>
                                <div class="tab-pane-modern fade <?php if(request()->is('publisher/profile/websites')): ?> active show <?php endif; ?>" id="v-pills-websites" role="tabpanel" aria-labelledby="v-pills-websites-tab">
                            ...
                            <?php elseif(request()->is('publisher/payments/billing-information')): ?>
                                <div class="tab-pane-modern fade <?php if(request()->is('publisher/payments/billing-information')): ?> active show <?php endif; ?>"
                                    id="v-pills-basic-settings" role="tabpanel" aria-labelledby="v-pills-basic-settings-tab">
                            ...
                            <?php elseif(request()->is('publisher/payments/payment-settings')): ?>
                                <div class="tab-pane-modern fade <?php if(request()->is('publisher/payments/payment-settings')): ?> active show <?php endif; ?>"
                            ...
                            <?php elseif(request()->is('publisher/account/login-info') || request()->is('publisher/account/login-info/*')): ?>
                                <div class="tab-pane-modern fade <?php if(request()->is('publisher/account/login-info') || request()->is('publisher/account/login-info/*')): ?> active show <?php endif; ?>"
                            ...
                            <?php elseif(request()->is('publisher/account/api-info') || request()->is('publisher/account/api-info/*')): ?>
                                <div class="tab-pane-modern fade <?php if(request()->is('publisher/account/api-info') || request()->is('publisher/account/api-info/*')): ?> active show <?php endif; ?>"
...
<?php echo $__env->make("layouts.publisher.panel_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\Downloads\revdb\resources\views/template/publisher/settings/index.blade.php ENDPATH**/ ?>