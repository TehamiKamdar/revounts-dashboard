<?php if (! $__env->hasRenderedOnce('12e70caa-7e6c-416c-a42a-cc11e2770dfe')): $__env->markAsRenderedOnce('12e70caa-7e6c-416c-a42a-cc11e2770dfe');
...
<?php if (! $__env->hasRenderedOnce('28072641-566e-47a4-863b-96543e9ea8e0')): $__env->markAsRenderedOnce('28072641-566e-47a4-863b-96543e9ea8e0');
                                ...
                                <div class="card-body text-center pt-4 pb-0 px-3">
                                    <div class="account-profile">
                                        <div class="ap-img w-100 d-flex justify-content-center mb-3">
                                            ...
                                            <?php if(!empty($advertiser->fetch_logo_url) && $advertiser->is_fetchable_logo): ?>
                                                <img loading="lazy" class="ap-img__main" src="<?php echo e($advertiser->fetch_logo_url); ?>"
                                                    alt="<?php echo e($advertiser->name); ?>">
                                            <?php elseif(!empty($advertiser->logo)): ?>
                                                <img class="ap-img__main"
                                                    src="<?php echo e(\App\Helper\Static\Methods::staticAsset("$advertiser->logo")); ?>"
                                                    alt="<?php echo e($advertiser->name); ?>">
                                            <?php else: ?>
                                    ...
                                    <div class="card-footer mt-4 pt-3 pb-3 px-0">
                                        <div class="profile-overview d-flex justify-content-between flex-wrap">
                                            ...
                                            <div class="po-details">
                                                <h6 class="po-details__title pb-1">
                                                    <?php echo e($advertiser->average_payment_time ?? "-"); ?> <span
                                    ...
                                    <div class="card-body pt-2 pb-3">
                                        <div class="user-content-info">
                                            <p class="user-content-info__item">
                                                <i class="ri-mail-line"></i><?php echo e($advertiser->user->email ?? "-"); ?>
                    ...
                    <div class="col-lg-9 col-md-8">
                        ...
                        <div class="ap-tab ap-tab-header mb-4">
                            <div class="ap-tab-header__img">
                                <img src="<?php echo e(\App\Helper\Static\Methods::staticAsset("img/placeholder-cover.png")); ?>"
                                                        ...
                                                        <div class="card-body">
                                                            <?php if(isset($advertiser->advertiser_applies->is_tracking_generate) && isset($advertiser->advertiser_applies->tracking_url) && $advertiser->advertiser_applies->is_tracking_generate == 1): ?>
                                                                <a href="<?php echo e($advertiser->advertiser_applies->tracking_url_long ?? $advertiser->advertiser_applies->tracking_url); ?>"
                                                                    target="_blank"
                                                                    id="trackingURL"><?php echo e($advertiser->advertiser_applies->tracking_url_long ?? $advertiser->advertiser_applies->tracking_url); ?></a>
                                                                <br><br>
                                                        ...
                                                        <div class="card-body">
                                                            <?php if(isset($advertiser->advertiser_applies->is_tracking_generate) && isset($advertiser->advertiser_applies->tracking_url_short) && $advertiser->advertiser_applies->is_tracking_generate == 1): ?>
                                                                <a href="<?php echo e($advertiser->advertiser_applies->tracking_url_short); ?>"
                                                                    id="trackingShortURL"
                                                                    target="_blank"><?php echo e($advertiser->advertiser_applies->tracking_url_short); ?></a>
                                                                <br><br>
                                                                <a href="javascript:void(0)"
