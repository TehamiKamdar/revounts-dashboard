            ...
            <form id="stepThree" action="javascript:void(0)">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="website_url" name="website_url" placeholder="https://www.domain.com" value="<?php echo e($stepThree['website_url'] ?? null); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <textarea class="form-control" id="brief_introduction" name="brief_introduction" rows="3" placeholder="Please write a brief introduction to help us and the brand get to know you quickly."><?php echo e($stepThree['brief_introduction'] ?? null); ?></textarea>
                    </div>
                </div>
                    ...
                    <div class="input-group">
                        <select name="categories[]" id="categories" class="form-control select2-custom" multiple="multiple">
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($category['id']); ?>" <?php echo e(isset($stepThree['categories']) && in_array($category['id'], $stepThree['categories']) ? 'selected' : null); ?>>
                    ...
                    <div class="input-group">
                        <select name="partner_types[]" id="partner_types" class="form-control select2-custom" multiple="multiple">
                            <?php $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($partner['id']); ?>" <?php echo e(isset($stepThree['partner_types']) && in_array($partner['id'], $stepThree['partner_types']) ? 'selected' : null); ?>>
                    ...
                    <div class="input-group">
                        <select class="form-control" id="website_country" name="website_country">
                            ...
                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php echo e(isset($stepThree['website_country']) && $stepThree['website_country'] == $country['id'] ? 'selected' : null); ?> value="<?php echo e($country['id']); ?>">
                                    <?php echo e(ucwords($country['name'])); ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="monthly_traffic" name="monthly_traffic" placeholder="e.g., 50,000" value="<?php echo e($stepThree['monthly_traffic'] ?? null); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="monthly_page_views" name="monthly_page_views" placeholder="e.g., 200,000" value="<?php echo e($stepThree['monthly_page_views'] ?? null); ?>">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make("auth.publisher_register.base", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\Downloads\revdb\resources\views/auth/publisher_register/step_three.blade.php ENDPATH**/ ?>