            ...
            <tbody id="websiteContent">
                <?php $__currentLoopData = $websites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $website): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="website-row-<?php echo e($website->id); ?>">
                                    <td>
                                        <a class="nav-link" href="<?php echo e(url($website->url)); ?>" target="_blank"><?php echo e($website->name); ?></a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <?php if($website->status == \App\Models\Website::PENDING): ?>
                                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#verify-modal"
                                                onclick="openVerifyModal('<?php echo e($website->id); ?>', '<?php echo e($website->url); ?>')">Verify</a> |
                                        <?php endif; ?>
                                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#website-modal"
                                            onclick="openWebsiteModal(1, '<?php echo e($website->id); ?>')">Edit</a>
                                    </td>
                                </tr>
            ...
            <div class="modal-content modal-bg-white">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="website_name" class="font-weight-bold text-black font-size14">Name<span
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="website_url" class="font-weight-bold text-black font-size14">URL<span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="partner_types" class="font-weight-bold text-black font-size14">Partner Type
                                    (Max. 3)<span class="text-danger">*</span></label>
                                <div class="atbd-select ">
                                    <select name="partner_types[]" id="partner_types" class="form-control"
                                        multiple="multiple">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="categories" class="font-weight-bold text-black font-size14">Category (Max.
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="monthly_traffic" class="font-weight-bold text-black font-size14">Monthly
                                    Traffic<span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="monthly_page_views" class="font-weight-bold text-black font-size14">Monthly
                                    Page Views<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="monthly_page_views"
                                    name="monthly_page_views" placeholder="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body" id="verifyForm">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a href="javascript:void(0)" id="copyHTMLTag"
                            class="btn btn-default btn-squared btn-outline-light btn-sm mt-2 float-right">Copy</a>
                    </div>
                </div>
...
</div><?php /**PATH C:\Users\lenovo\Downloads\revdb\resources\views/template/publisher/settings/websites/index.blade.php ENDPATH**/ ?>