<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        $("#year, #month").change(function () {
            ...
            if(year && month) {
                $.ajax({
                    url: '<?php echo e(route("publisher.get-month-last-day")); ?>',
                    type: 'GET',
                    data: {year, month},
...
<?php /**PATH C:\Users\lenovo\Desktop\revdb\resources\views/template/publisher/settings/basic_info/js.blade.php ENDPATH**/ ?>