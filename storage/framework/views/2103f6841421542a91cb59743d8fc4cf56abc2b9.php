<?php $__env->startSection("content"); ?>
        <?php if(($isStepOne && !$isStepTwo && !$isStepThree) || (!$isStepOne && !$isStepTwo && !$isStepThree)): ?>
            <?php echo $__env->make("auth.advertiser_register.step_one", $stepOne, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <?php elseif(!$isStepOne && $isStepTwo && !$isStepThree): ?>
            <?php echo $__env->make("auth.advertiser_register.step_two", $stepTwo, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <?php elseif(!$isStepOne && !$isStepTwo && $isStepThree): ?>
            <?php echo $__env->make("auth.advertiser_register.step_three", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush("scripts"); ?>
    ...
    <script>
        ...
        function stepFormShow(page) {
            ...
            $.ajax({
                url: '<?php echo e(route("advertiser-step-form")); ?>',
                type: 'GET',
                data: { page, account },
        ...
        function loadStepOneForm() {
            ...
            $("#stepOne").validate({
                ...
                submitHandler: function () {
                    ...
                    $.ajax({
                        url: '<?php echo e(route("advertiser-step-one")); ?>',
                        type: 'POST',
        ...
        function loadStepTwoForm() {
            ...
            $("#stepTwo").validate({
                ...
                submitHandler: function () {
                    ...
                    $.ajax({
                        url: '<?php echo e(route("advertiser-step-two")); ?>',
                        type: 'POST',
                        headers: { 'X-CSRF-Token': $('meta[name="csrf-token"]').attr('content') },
                        data: data,
                        success: function (response) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make("layouts.panel_guest", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\Downloads\revdb\resources\views/auth/advertiser_register.blade.php ENDPATH**/ ?>